...
export function FeaturesShowcaseSection() {
  ...
  useGSAP(
    () => {
      ...
      // Lerp factors - reduced for slower, smoother video updates on mobile
      ...
      ScrollTrigger.create({
        trigger: section,
        start: "top 25%", // Start earlier when section is 25% from viewport top
        end: "bottom bottom",
