...
function ResetPasswordContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateForm() || !resetUrl) return;
  ...
  if (!isValidLink) {
    return (
      <div className="min-h-screen flex bg-white overflow-hidden">
        ...
        {/* Right Section - Invalid Link Message */}
        <div className="flex-1 flex flex-col min-h-screen relative bg-white">
          ...
          <div className="flex-1 flex items-center justify-center px-4 py-8 lg:py-0 relative z-10">
            <motion.div
              className="w-full max-w-[454px] text-center space-y-6"
            ...
            >
              <motion.div
                ...
                className="w-20 h-20 mx-auto rounded-full flex items-center justify-center bg-red-100"
              >
              ...
              <Link href="/forgot-password">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full h-[48px] lg:h-[52px] rounded-[36px] flex items-center justify-center text-[#FFFCDC] font-display font-semibold text-[14px] lg:text-[16px] leading-none transition-all duration-300"
                  style={{
                    background:
